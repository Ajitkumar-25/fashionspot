    ...
    <div className="container mx-auto p-4">
      ...
      <div className=" my-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product, index) => (
          <div key={index} className="bg-white m-2 shadow-2xl  rounded-lg overflow-hidden ">
            <img
              src={product.image}
              alt={product.title}
            ...
            <div className="p-4">
              ...
              <div className="mt-2">
                ...
                <span className="text-gray-500"> • {product.availableQty} in stock</span>
              </div>
              <div className="mt-2">
                <span className="text-gray-500">Sizes: {product.size.join(" ")}</span>
              </div>
              <div className="mt-2">
                <span className="text-gray-500">Colors: {product.color.join(" ")}</span>
              </div>
